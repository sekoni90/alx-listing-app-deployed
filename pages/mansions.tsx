    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="bg-gradient-to-r from-purple-600 to-indigo-700 text-white py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-4">Luxury Mansions</h1>
          <p className="text-lg md:text-xl lg:text-2xl text-purple-100">Experience ultimate luxury and comfort</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        {loading ? (
          ...
          <div className="text-center py-16 md:py-20">
            <p className="text-xl md:text-2xl text-gray-600">No mansions available at the moment</p>
          </div>
        )}
      </div>
    </div>
